const validateNewJob = (req, res, next) => {
    ...
    const { companyName, logoUrl, jobTitle, monthlySalary, jobType, remote, location, jobDescription, aboutCompany, skillsRequired } = req.body;
    if (!companyName || !logoUrl || !jobTitle || !monthlySalary || !jobType || !location || !jobDescription || !aboutCompany || !skillsRequired) {
